...
const copy = {
  en: {
    ...
    form: {
      ...
      sending: "Preparing…",
      sent: "Email prepared",
      followUp: "Review it and send it from your mail app.",
  ...
  ru: {
    ...
    form: {
      ...
      send: "Подготовить письмо",
      sending: "Готовим…",
      sent: "Письмо подготовлено",
      followUp: "Проверьте и отправьте его из почтового приложения.",
